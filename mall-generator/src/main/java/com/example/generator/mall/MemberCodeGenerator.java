package com.example.generator.mall;
...
public class MemberCodeGenerator {
    ...
    // TODO 修改服务名以及数据表名
    private static final String SERVICE_NAME = "ums";
    ...
    public static void main(String[] args) {
        ...
        //生成路径
        gc.setOutputDir(System.getProperty("user.dir") + "/generator");
        gc.setAuthor("zhuwenjie");
        gc.setOpen(false);
        ...
        dsc.setUrl("jdbc:mysql://192.168.2.100:3306/gulimall_" + SERVICE_NAME
