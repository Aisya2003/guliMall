...
import com.example.mall.order.mapper.MqMessageMapper;
...
public class MqMessageServiceImpl extends ServiceImpl<MqMessageMapper, MqMessage> implements MqMessageService {
    ...
    @Override
    public void saveSendFailMessage(Order order, String exchangeName, String routingKey) {
        saveMessage(order, exchangeName, routingKey, RabbitMQConstant.MqMessageStatusEnum.CREATE.getCode());
    }

    private void saveMessage(Order order, String exchangeName, String routingKey, Integer errorCode) {
        MqMessage mqMessage = new MqMessage();
        mqMessage.setClassType(order.getClass().toString());
